		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sync6c1paymentchart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6c1paymentchart-display": {
								"semanticObject": "sync6c1paymentchart",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.c1.paymentchart",
									"url": sap.ui.require.toUrl("sync6/c1/paymentchart")
								}
							}
						}
					}
