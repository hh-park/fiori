		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Flight master",
									"targetURL": "#sync6c1sync6spfli-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6c1sync6spfli-display": {
								"semanticObject": "sync6c1sync6spfli",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.c1.sync6spfli",
									"url": sap.ui.require.toUrl("sync6/c1/sync6spfli")
								}
							}
						}
					}
