		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Get cart item",
									"targetURL": "#sync6cl1cartproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync6cl1cartproject-display": {
								"semanticObject": "sync6cl1cartproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync6.cl1.cartproject",
									"url": sap.ui.require.toUrl("sync6/cl1/cartproject")
								}
							}
						}
					}
